...
function pcsd_assets()
{
	...
	wp_enqueue_style('main', get_template_directory_uri() . '/assets/css/main.css', '', '1.0.24', false);
	wp_enqueue_style('fonts', get_template_directory_uri() . '/assets/css/font.css', '', '1.0.02', false);
	wp_enqueue_style('header', get_template_directory_uri() . '/assets/css/header.css', '', '1.0.06', false);
	...
	if (is_front_page()) {
		wp_enqueue_style('front_page', get_template_directory_uri() . '/assets/css/frontpage.css', array(), '1.0.13', false);
	}
	if (is_page_template(
		array(
