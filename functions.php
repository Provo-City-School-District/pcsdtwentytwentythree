...
function pcsd_assets()
{
	...
	wp_enqueue_style('main', get_template_directory_uri() . '/assets/css/main.css', '', '1.0.21', false);
	...
	if (is_front_page()) {
		wp_enqueue_style('front_page', get_template_directory_uri() . '/assets/css/frontpage.css', array(), '1.0.12', false);
	}
	if (is_page_template(
		array(
